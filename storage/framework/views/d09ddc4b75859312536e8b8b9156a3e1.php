                ...
                <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="w-full sm:w-1/4 lg:w-1/5 p-2">
                        <div class="rounded-2xl bg-white shadow cursor-pointer h-[120px] stage-card"
                            data-pipeline-id="<?php echo e($pipeline->pipeline_id); ?>" data-pipeline-name="<?php echo e($pipeline->pipeline_name); ?>">
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div>
                                      <div class="h-10"><p class="text-sm text-gray-900"><b><?php echo e($pipeline->pipeline_name); ?></b></p></div>
                                        <div class="mt-0 flex items-center gap-4">
                                            <h5 class="m-0 text-[22px] font-extrabold text-slate-500">
                                                $<?php echo e(number_format($pipeline->total_monetary_value, 2)); ?>

                                            </h5>
                                            <p class="m-0 text-sm font-bold text-blue-600"
                                                data-pipeline-id="<?php echo e($pipeline->pipeline_id); ?>">
                                                <?php echo e($pipeline->total_stages); ?> stages
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="p-4 sm:p-6">
                            <div class="flex flex-col sm:flex-col sm:items-center sm:justify-between mb-4 gap-4">
                                ...
                                <select name="pipelineStages" id="pipelineStages"
                                    ...
                                    <?php $__currentLoopData = $totalPiplines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex flex-col sm:flex-col sm:items-center sm:justify-between mb-4 gap-4">
                                ...
                                <select id="pipelineSelect"
                                    class="w-full sm:max-w-xs md:max-w-sm rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 
                                                                                    shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition truncate">
                                    <option value="">-- Select Pipeline --</option>
                                    <?php $__currentLoopData = $PipelinesIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('template/js/backend-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/customizer.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/sidebar.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/flex-tree.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/tree.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/table-treeview.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/sweetalert.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/vector-map-custom.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/chart-custom.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/chart_1.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/chart_2.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/slider.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetchPiplineVelocity() {
                $.ajax({
                    url: "<?php echo e(route('admin.pipelineVelocity')); ?>",
                    type: "GET",
                    data: {
                        userId: userId
                    },
            ...
            function updateAllCharts() {
                ...
                const url = "<?php echo e(route('admin.updateAllCharts')); ?>";
            ...
            $(document).on("click", ".stage-card", function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.singlePiplineStageConversion')); ?>",
                    type: "GET",
                    data: {
            ...
            function loadMonthlyChart() {
                $.ajax({
                    url: "<?php echo e(route('admin.piplinesData')); ?>",
                    method: "GET",
                    data: {
                        userId: null
                    },
            ...
            function loadPieChart() {
                $.ajax({
                    url: "<?php echo e(route('admin.opportunitiesStatusPieChart')); ?>",
                    method: "GET",
            ...
            $('#pipelineStages').on('change', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.pipelineStageDistribution')); ?>",
                    type: "GET",
                    data: {
        ...
        document.getElementById('pipelineSelect').addEventListener('change', function () {
            ...
            fetch("<?php echo e(route('admin.pipeline.stages')); ?>", {
                method: 'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/admin/opportunities.blade.php ENDPATH**/ ?>