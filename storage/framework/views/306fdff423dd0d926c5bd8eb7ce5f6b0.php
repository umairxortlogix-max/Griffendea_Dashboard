...
<head>
  ...
  <title><?php echo e(env('APP_NAME','Xortlogix Toolkit')); ?></title>
        ...
        <form class="space-y-6" method="POST" action="<?php echo e(route('login')); ?>">
          ...
          <div class="mb-8">
            <div class="flex items-center mb-6">
              ...
              <h1 class="text-2xl font-bold navy-text ml-3"><?php echo e(env('APP_NAME','Xortlogix Toolkit')); ?></h1>
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
              <span class="text-red-500 text-sm block mt-1"><?php echo e($message); ?></span>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <!--      <h2 class="text-3xl font-bold mb-4">Welcome to <?php echo e(env('APP_NAME','Xortlogix Toolkit')); ?></h2>-->
...
<?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>