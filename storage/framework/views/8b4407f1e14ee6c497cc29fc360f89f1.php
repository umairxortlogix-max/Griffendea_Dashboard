            ...
            <?php if(is_role() == 'super_admin'): ?>
                <div class="col-span-12 xl:col-span-6 xl:col-start-4">
                    <div
                        ...
                        <form method="POST" action="<?php echo e(route('admin.setting.save')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name"
                                        ...
                                        ID</label>
                                    <input type="text" value="<?php echo e($settings['crm_client_id'] ?? ''); ?>" id="crm_client_id"
                            ...
                            <div class="mb-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Client
                                        secret</label>
                                    <input type="text" value="<?php echo e($settings['crm_client_secret'] ?? ''); ?>" id="crm_secret_id"
            ...
            <?php if(is_role() == 'admin'): ?>
                <div class="col-span-12 sm:col-span-10 md:col-span-8 xl:col-span-6 xl:col-start-4">
                    <div
                        ...
                        <a href="<?php echo e(CRM::directConnect()); ?>"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            Connect <?php echo e(is_role() == 'super_admin' ? 'Agency' : 'Location'); ?>/CRM
                        </a>
                                    ...
                                    class="grid grid-cols-12 mt-4 gap-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                                        ...
                                        <div class="col-span-12 xl:col-span-6 xl:col-start-4">
                                            <div
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.subaccount.policies')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="col-span-6 sm:col-span-3">
                                                            ...
                                                            <input type="text" value="<?php echo e($policies['policies'] ?? ''); ?>" name="policies[policies]"
                                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="col-span-6 sm:col-span-3">
                                                            ...
                                                            <input type="text"  value="<?php echo e($policies['premium']  ?? ''); ?>" name="policies[premium]"
                                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <div class="flex items-center justify-center w-full">
                <label id="dropzone" for="dropzone-file"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        <?php if($logo): ?>
                            <img src="<?php echo e(asset('logo/' . $logo->value)); ?>" alt="Current Logo"
    ...
    <script>
        $(document).ready(function () {
            $('#sync-location-data-btn').click(function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('crm.syn.location.data')); ?>",
                    type: 'GET',
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function uploadImage(file) {
                ...
                fetch("<?php echo e(route('admin.setting.saveLogo')); ?>", {
                    method: "POST",
                    headers: {
            ...
            const form = document.querySelector("form[action='<?php echo e(route('admin.setting.save')); ?>']");
            if (form) {
...
function uploadChunks(data, csrfToken, chunkSize = 100) {
    ...
    function sendChunk() {
        if (currentChunk < totalChunks) {
            ...
            $.ajax({
                url: "<?php echo e(route('uploadChunks')); ?>",
                type: 'POST',
                headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>