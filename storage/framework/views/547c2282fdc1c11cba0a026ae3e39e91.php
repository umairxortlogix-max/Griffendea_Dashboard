    ...
    <div class="main-content w-full flex-1 p-4 md:p-6 mt-16">
        ...
        <div class="dashboard-stats gap-5 mb-8">
            ...
            <footer class="text-center mt-8 pt-5 border-t border-gray-200">
                <p class="text-gray-600">&copy; 2025<?php echo e(env('APP_NAME', 'Xortlogix Toolkit')); ?> . All rights reserved.
                </p>
            </footer>
        </div>
...
<?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/admin/layouts/index.blade.php ENDPATH**/ ?>