    ...
    <div class="mx-auto max-w-8xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-4 items-center mt-3 sm:mt-0">
                ...
                <div>
                    ...
                    <select id="perPage" class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-200">
                       <option value="50" <?php echo e(request('per_page', 50) == 50 ? 'selected' : ''); ?>>50</option>
                        <option value="10" <?php echo e(request('per_page', 50) == 10 ? 'selected' : ''); ?>>10</option>
                        <option value="25" <?php echo e(request('per_page', 50) == 25 ? 'selected' : ''); ?>>25</option>
                        
                        <option value="100" <?php echo e(request('per_page', 50) == 100 ? 'selected' : ''); ?>>100</option>
                    </select>
                </div>
        ...
        <div class="relative bg-white p-6 rounded-lg shadow">
            ...
            <div id="stageHistoryContent">
                <?php echo $__env->make('admin.partials.stage_history_table', ['pipelines' => $pipelines], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>

            <!-- Pagination -->
            <div id="paginationContainer" class="mt-6">
                <?php if(isset($paginatedLogs)): ?>
                    <?php echo $__env->make('admin.partials.pagination', ['logs' => $paginatedLogs], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchData(page = 1) {
        ...
        fetch(`<?php echo e(route('admin.OpportunityStageHistory')); ?>?${params.toString()}`, {
            headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/admin/OpportunityStageHistory.blade.php ENDPATH**/ ?>