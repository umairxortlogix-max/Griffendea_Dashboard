    ...
    <script>
        $(document).ready(function() {
            let table = $('#searchtable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('admin.subaccount.index')); ?>",
                    type: 'GET',
                    error: function(xhr) {
            ...
            $('body').on('click', '.confirm-delete', function(e) {
                ...
                const url = '<?php echo e(route('admin.user.destroy', ':id')); ?>'.replace(':id', userId);
            ...
            $('body').on('click', '.status_changes', function(e) {
                ...
                const url = "<?php echo e(route('admin.user.status', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('admin.layouts.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u878439255/domains/lightsalmon-boar-673636.hostingersite.com/public_html/resources/views/admin/subaccount/index.blade.php ENDPATH**/ ?>